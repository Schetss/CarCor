...
namespace Frontend\Modules\Logos\Actions;
...
/**
 * This is the category-action, it will display the overview of Logos categories
 *
...
class Category extends Block
{
    ...
    private function getData()
    {
        ...
        // get category
        $this->category = FrontendLogosModel::getCategory($this->URL->getParameter(0));
        ...
        // set URL and limit
        $this->pagination['url'] = Navigation::getURLForBlock('Logos', 'category') . '/' . $this->category['url'];

        $this->pagination['limit'] = $this->get('fork.settings')->get('Logos', 'overview_num_items', 10);

        // populate count fields in pagination
        $this->pagination['num_items'] = FrontendLogosModel::getCategoryCount($this->category['id']);
        ...
        // get items
        $this->items = FrontendLogosModel::getAllByCategory(
