...
/**
 * This is the category-action, it will display the overview of Kwaliteitslabels categories
 *
...
class Category extends Block
{
    ...
    private function getData()
    {
        ...
        // get category
        $this->category = FrontendKwaliteitslabelsModel::getCategory($this->URL->getParameter(0));
        ...
        // set URL and limit
        $this->pagination['url'] = Navigation::getURLForBlock('Kwaliteitslabels', 'category') . '/' . $this->category['url'];

        $this->pagination['limit'] = $this->get('fork.settings')->get('Kwaliteitslabels', 'overview_num_items', 10);

        // populate count fields in pagination
        $this->pagination['num_items'] = FrontendKwaliteitslabelsModel::getCategoryCount($this->category['id']);
        ...
        // get items
        $this->items = FrontendKwaliteitslabelsModel::getAllByCategory(
