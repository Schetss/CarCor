...
namespace Frontend\Modules\Kwaliteitslabels\Engine;
...
class Model
{
    ...
    public static function get($URL)
    {
        ...
        // create full url
        $item['full_url'] = Navigation::getURLForBlock('Kwaliteitslabels', 'Detail') . '/' . $item['url'];
    ...
    public static function getAll($limit = 10, $offset = 0)
    {
        ...
        $detailUrl = Navigation::getURLForBlock('Kwaliteitslabels', 'Detail');
    ...
    public static function getAllCategories()
    {
        $return = (array) FrontendModel::get('database')->getRecords(
            'SELECT id, naam AS name, logo AS logo, omschrijving AS description, 
            achtergrondafbeelding AS image 
            FROM kwaliteitslabels
    ...
    public static function getCategory($URL)
    {
        ...
        // create full url
        $item['full_url'] = Navigation::getURLForBlock('Kwaliteitslabels', 'category') . '/' . $item['url'];
