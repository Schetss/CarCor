...
namespace Frontend\Modules\Werkwijze\Actions;
...
/**
 * This is the category-action, it will display the overview of Werkwijze categories
 *
...
class Category extends Block
{
    ...
    private function getData()
    {
        ...
        // get category
        $this->category = FrontendWerkwijzeModel::getCategory($this->URL->getParameter(0));
        ...
        // set URL and limit
        $this->pagination['url'] = Navigation::getURLForBlock('Werkwijze', 'category') . '/' . $this->category['url'];

        $this->pagination['limit'] = $this->get('fork.settings')->get('Werkwijze', 'overview_num_items', 10);

        // populate count fields in pagination
        $this->pagination['num_items'] = FrontendWerkwijzeModel::getCategoryCount($this->category['id']);
        ...
        // get items
        $this->items = FrontendWerkwijzeModel::getAllByCategory(
