...
namespace Frontend\Modules\Werkwijze\Engine;
...
class Model
{
    ...
    public static function get($URL)
    {
        ...
        // create full url
        $item['full_url'] = Navigation::getURLForBlock('Werkwijze', 'Detail') . '/' . $item['url'];
    ...
    public static function getAll($limit = 10, $offset = 0)
    {
        ...
        $detailUrl = Navigation::getURLForBlock('Werkwijze', 'Detail');
    ...
    public static function getAllCategories()
    {
        $return = (array) FrontendModel::get('database')->getRecords(
            'SELECT id, titel AS title, omschrijving AS description, afbeelding AS image
             FROM werkwijze
    ...
    public static function getCategory($URL)
    {
        ...
        // create full url
        $item['full_url'] = Navigation::getURLForBlock('Werkwijze', 'category') . '/' . $item['url'];
