...
namespace Frontend\Modules\OnsTeam\Actions;
...
/**
 * This is the category-action, it will display the overview of Ons team categories
 *
...
class Category extends Block
{
    ...
    private function getData()
    {
        ...
        // get category
        $this->category = FrontendOnsTeamModel::getCategory($this->URL->getParameter(0));
        ...
        // set URL and limit
        $this->pagination['url'] = Navigation::getURLForBlock('OnsTeam', 'category') . '/' . $this->category['url'];

        $this->pagination['limit'] = $this->get('fork.settings')->get('OnsTeam', 'overview_num_items', 10);

        // populate count fields in pagination
        $this->pagination['num_items'] = FrontendOnsTeamModel::getCategoryCount($this->category['id']);
        ...
        // get items
        $this->items = FrontendOnsTeamModel::getAllByCategory(
