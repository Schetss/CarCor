...
namespace Frontend\Modules\OnsTeam\Engine;
...
class Model
{
    ...
    public static function get($URL)
    {
        ...
        // create full url
        $item['full_url'] = Navigation::getURLForBlock('OnsTeam', 'Detail') . '/' . $item['url'];
    ...
    public static function getAll($limit = 10, $offset = 0)
    {
        ...
        $detailUrl = Navigation::getURLForBlock('OnsTeam', 'Detail');
    ...
    public static function getAllCategories()
    {
        $return = (array) FrontendModel::get('database')->getRecords(
            'SELECT id, naam AS name, functie AS function, 
            omschrijving AS description, afbeelding AS image
            FROM ons_team 
    ...
    public static function getCategory($URL)
    {
        ...
        // create full url
        $item['full_url'] = Navigation::getURLForBlock('OnsTeam', 'category') . '/' . $item['url'];
