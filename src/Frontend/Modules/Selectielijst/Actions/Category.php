...
namespace Frontend\Modules\Selectielijst\Actions;
...
/**
 * This is the category-action, it will display the overview of Selectielijst categories
 *
...
class Category extends Block
{
    ...
    private function getData()
    {
        ...
        // get category
        $this->category = FrontendSelectielijstModel::getCategory($this->URL->getParameter(0));
        ...
        // set URL and limit
        $this->pagination['url'] = Navigation::getURLForBlock('Selectielijst', 'category') . '/' . $this->category['url'];

        $this->pagination['limit'] = $this->get('fork.settings')->get('Selectielijst', 'overview_num_items', 10);

        // populate count fields in pagination
        $this->pagination['num_items'] = FrontendSelectielijstModel::getCategoryCount($this->category['id']);
        ...
        // get items
        $this->items = FrontendSelectielijstModel::getAllByCategory(
