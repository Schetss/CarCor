...
class AddCategory extends ActionAdd
{
    ...
    private function loadForm()
    {
        ...
        $this->meta->setURLCallback('Backend\Modules\Kwaliteitslabels\Engine\Model', 'getURLForCategory');
    }
    ...
    private function validateForm()
    {
        if ($this->frm->isSubmitted()) {
            ...
            if ($this->frm->isCorrect()) {
                ...
                $item['sequence'] = BackendKwaliteitslabelsModel::getMaximumCategorySequence() + 1;

                // save the data
                $item['id'] = BackendKwaliteitslabelsModel::insertCategory($item);
