...
class EditCategory extends ActionEdit
{
    ...
    private function getData()
    {
        ...
        $this->record = BackendKwaliteitslabelsModel::getCategory($this->id);
    }
    ...
    private function loadForm()
    {
        ...
        $this->meta->setUrlCallback('Backend\Modules\Kwaliteitslabels\Engine\Model', 'getURLForCategory', array($this->record['id']));
    }
