...
class AddCategory extends ActionAdd
{
    ...
    private function loadForm()
    {
        ...
        $this->meta->setURLCallback('Backend\Modules\Werkwijze\Engine\Model', 'getURLForCategory');
    }
    ...
    private function validateForm()
    {
        if ($this->frm->isSubmitted()) {
            ...
            if ($this->frm->isCorrect()) {
                ...
                $item['sequence'] = BackendWerkwijzeModel::getMaximumCategorySequence() + 1;

                // save the data
                $item['id'] = BackendWerkwijzeModel::insertCategory($item);
