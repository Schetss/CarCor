...
class EditCategory extends ActionEdit
{
    ...
    private function getData()
    {
        ...
        if ($this->id == null || !BackendSelectielijstModel::existsCategory($this->id)) {
            $this->redirect(
                Model::createURLForAction('categories') . '&error=non-existing'
            );
        }

        $this->record = BackendSelectielijstModel::getCategory($this->id);
    }
    ...
    private function loadForm()
    {
        ...
        $this->meta->setUrlCallback('Backend\Modules\Selectielijst\Engine\Model', 'getURLForCategory', array($this->record['id']));
    }
    ...
    private function validateForm()
    {
        if ($this->frm->isSubmitted()) {
            ...
            if ($this->frm->isCorrect()) {
                ...
                // update the item
                BackendSelectielijstModel::updateCategory($item);
